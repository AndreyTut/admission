...
<div style="margin: 20px">
    <div class="row">
        <div class="col-md-2 col-md-offset-10">
            <form action="${pageContext.request.contextPath}/command/user/addfaculty" method="get">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <th>
                <fmt:message key="table.faculty.submit"/>
            </th>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${faculties}" var="faculty">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/command/user/addfaculty?id=${faculty.id}">
